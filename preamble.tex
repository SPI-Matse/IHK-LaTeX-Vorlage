...
% ##################################################
% Personal data
\newcommand{\docAuthor}{Dominik Meurer}
\newcommand{\docMatriculationNumber}{169 52137}
\newcommand{\docEmail}{dom.meurer@gmx.de}

\newcommand{\docAusbildungsbetrieb}{Aesculap AG}
\newcommand{\docStreetName}{Am Aesculap Platz}
\newcommand{\docPostalCode}{78523}
\newcommand{\docCity}{Tuttlingen}


% Document data
\newcommand{\docTitle}{Average Speed}
\newcommand{\docType}{Abschlussprüfung}
\newcommand{\docDeadline}{17.06.2024}
\newcommand{\docStudyProgram}{Mathematisch- Technischer Softwareentwickler}
\newcommand{\docSubTitle}{Dokumentation zur Prüfungsaufgabe}
...
\parskip1.5ex % Abstand zwischen Absätzen
...
\renewcommand{\lstlistlistingname}{Liste der Codeblöcke}   % 
